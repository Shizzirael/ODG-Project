/*
 File:        main.c
 Autori:      Assia, Fabiana, Lucia
 Descrizione: Punto di ingresso del programma. Gestisce il menu principale
              a piu' livelli e coordina i tre moduli:
                - richieste  (lista collegata)
                - tecnici    (lista collegata ordinata per carico)
                - schedule   (albero binario di ricerca per data/ora)
*/
