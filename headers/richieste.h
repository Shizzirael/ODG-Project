...
/* Struttura per rappresentare una singola richiesta di intervento tecnico,
   con tutti i dati necessari a tracciarne il ciclo di vita */
...
// Coda a priorita' basata su Max-Heap (indice 1-based: heap[0] non usato) 
typedef struct {
...
>>>>>>> c520d1f14b61dc6700527b53e74df3efd7792ddb
/*
...
Pre-condizioni:
- testa != NULL  (*testa puo' essere NULL se la lista e' vuota)
- nuova != NULL
...
finche' l'invariante Max-Heap e' ripristinato.
